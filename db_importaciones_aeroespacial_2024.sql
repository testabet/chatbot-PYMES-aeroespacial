DROP DATABASE IF EXISTS importaciones_aeroesp_2024;
CREATE DATABASE IF NOT EXISTS importaciones_aeroesp_2024;
USE importaciones_aeroesp_2024;
...
CREATE TABLE paises(
    ...
    eci_sitc DECIMAL(4,3) COMMENT 'Indice de complejidad económica calculado utilizando la clasificación SITC de productos',
    PRIMARY KEY (id_pais),
...
CREATE TABLE productos (
    ...
    codigo_sitc SMALLINT UNSIGNED NOT NULL COMMENT 'Código de clasificaicón uniforme para el comercio internacional (SITC por sus siglas en ingles)',
